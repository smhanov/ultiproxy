...
// Capabilities returns DeepSeek capabilities.
...
// Critical: on input, re-emit prior reasoning as reasoning_content.
// On output, extract reasoning into returned ir assistant blocks.
